...
protoFile = "../models/bvlc_googlenet.prototxt"
weightFile = "../models/bvlc_googlenet.caffemodel"

frame = cv2.imread("../data/images/panda.jpg")

classFile = "../models/classification_classes_ILSVRC2012.txt"
